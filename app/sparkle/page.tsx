              ...
              <div>
                ...
                <div className="card" style={{ borderColor: `${world.color}15` }}>
                  ...
                  {[
                    ...
                    <div key={q} onClick={() => setCoachMsg(q)} style={{ padding: '8px 12px', background: 'var(--bg3)', borderRadius: '6px', marginBottom: '6px', cursor: 'pointer', fontSize: '12px', color: 'var(--w2)', transition: 'all .2s' }}
