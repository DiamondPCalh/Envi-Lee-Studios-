...
type LegalTool = 'dashboard' | 'vault' | 'forms' | 'idcard' | 'birth' | 'prenup' | 'platform' | 'assets' | 'disclaimers' | 'templates' | 'saved' | 'trademark' | 'namecheck' | 'ipprotection' | 'dmca' | 'charactertimestamp'
