...
const css = `
  :root {
    ...
    --pod2:linear-gradient(135deg,#ff2255,#ff5500,#ffaa00);
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .lbar-fill{height:100%;background:linear-gradient(135deg,#ff2255,#ff4400,#ff6600,#ffaa00);background-size:200% 100%;animation:lbar 2s linear infinite;}
  ...
  /* ── BUTTONS ── */
  .pod-btn{padding:11px 20px;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;border:none;background:linear-gradient(135deg,#ff2255,#ff4400,#ff6600,#ffaa00);color:#fff;font-family:'DM Sans',sans-serif;transition:all .2s;box-shadow:0 0 20px rgba(255,68,0,0.3);}
    ...
    <div className="pg-in" style={{ padding: '28px' }}>
      <div style={{ marginBottom: '28px' }}>
        ...
        <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '36px', fontWeight: 400, color: '#fff', marginBottom: '4px' }}>
          POD <span style={{ background: 'linear-gradient(135deg,#ff2255,#ff4400,#ff6600,#ffaa00,#ffcc00)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Studios™</span>
        </div>
            ...
            <div className="top-nav">
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 20px 0' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <div style={{ fontFamily: "'Syne',sans-serif", fontSize: '16px', fontWeight: 900, background: 'linear-gradient(135deg,#ff2255,#ff4400,#ff6600,#ffaa00,#ffcc00)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    POD Studios™
                  </div>
                </div>
